...
#     def display(self):
#         print((self.get_level() * " " * 2) +self.data)
#         for child in self.children:
#             child.display()
...
#     cell_phone.add_child(TreeNode('VEVO'))

#     Electronics.add_child(laptop)
#     Electronics.add_child(tv)
#     Electronics.add_child(cell_phone)
...
if __name__ == "__main__":
    elements = [17,4,1,20,9,23,28,24]

    btree = build_tree(elements)
